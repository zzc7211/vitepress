import{_ as a}from"./plugin-vue_export-helper.21dcd24c.js";import{b as n,o as s,K as e}from"./vendor.18923375.js";const y='{"title":"Theme Config: Algolia Search","description":"","frontmatter":{},"headers":[{"level":2,"title":"Internationalization (i18n)","slug":"internationalization-i18n"}],"relativePath":"config/algolia-search.md","lastUpdated":1642158167143}',t={},o=e(`<h1 id="theme-config-algolia-search" tabindex="-1">Theme Config: Algolia Search <a class="header-anchor" href="#theme-config-algolia-search" aria-hidden="true">#</a></h1><p>The <code>themeConfig.algolia</code> option allows you to use <a href="https://docsearch.algolia.com/" target="_blank" rel="noopener noreferrer">Algolia DocSearch</a>. To enable it, you need to provide at least apiKey and indexName:</p><div class="language-js"><pre><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>VitePress will automatically add a <code>lang</code> <em>facetFilter</em> to the <code>searchParameters.facetFilter</code> array with the correct language value. Algolia automatically adds the correct facet filter based on the <code>lang</code> attribute on the <code>&lt;html&gt;</code> tag. This will match search results with the currently viewed language of the page.</p>`,9),p=[o];function r(l,c,i,u,d,k){return s(),n("div",null,p)}var m=a(t,[["render",r]]);export{y as __pageData,m as default};
